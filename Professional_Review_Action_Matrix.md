...
| Commit to code/data release | Updated generated declarations to "Code and Data Availability" with GitHub/Zenodo release commitment and added release metadata/checklist for public repository upload | `experiments/write_submission_manuscript.py`; `GITHUB_ZENODO_RELEASE_CHECKLIST.md`; `CITATION.cff` |
