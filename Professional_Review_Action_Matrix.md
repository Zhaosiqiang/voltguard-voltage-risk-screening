...
| Commit to code/data release | Updated generated declarations to "Code and Data Availability", published the package on GitHub, enabled Zenodo integration, and minted DOI `10.5281/zenodo.21149702` | `experiments/write_submission_manuscript.py`; `GITHUB_ZENODO_RELEASE_CHECKLIST.md`; `CITATION.cff`; `https://github.com/Zhaosiqiang/voltguard-voltage-risk-screening/releases/tag/v1.0.0-submission`; `https://doi.org/10.5281/zenodo.21149702` |
